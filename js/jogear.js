...
(function() {
  var Node, colors, destory, draw, headers, init, nodeList, prev, root, topMargin, update,
    __slice = [].slice;
  ...
  Node = (function() {
    function Node(el) {
      ...
      if (el) {
        ...
        this.title = this.title.replace(/\([\w\s]+\)/g, '');
  ...
  setInterval(function() {
    ...
    if (this.scrolling) {
      ...
      for (index = _i = 0, _len = nodeList.length; _i < _len; index = ++_i) {
        ...
        if (top > window.scrollY + topMargin) {
